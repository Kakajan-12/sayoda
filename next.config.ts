...
const nextConfig: NextConfig = {
  ...
  images: {
     ...
     * quality={90} без этой записи просто ничего бы не изменил, и найти
     * причину можно было бы только по предупреждению в логе сборки.
     *
     * 90 нужен главной фотографии тура: она занимает почти тысячу пикселей
     * по ширине, и на ней разница между 75 и 90 видна на мелких деталях —
     * плитке, орнаменте, песке. Остальные картинки остаются на 75.
     */
    qualities: [75, 90],
    remotePatterns: [
      {
