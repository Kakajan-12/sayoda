  ...
  return (
    <div className='relative w-full'>
         ...
         <div className="absolute text-start pt-20  md:pt-0 w-full h-full  top-0  ">
           ...
           <h1 className={`${PoppinFont.className }  sm:px-2 dort:text-3xl text-2xl sm:text-4xl  lg:text-5xl xl:text-4xl 2xl:text-6xl  font-bold text-center text-white leading-8 lg:leading-[65px] xl:leading-[75px] 2xl:leading-[80px] tracking-wide`}>{t("title")}</h1>
         </div>
         </div>
    </div>
  )
