...
import aboutImg from "../../../public/AboutImgs/about.jpg";
    ...
    <div className="w-full  relative ">
        ...
        <div className="relative w-full h-full flex mx-auto justify-between z-0">
          <div className="relative w-full h-full">
            <Image
              ...
              src={aboutImg}
            />
            <div className="absolute inset-0 bg-gradient-to-b from-mainBlue/80 via-black/50 to-black/70 pointer-events-none" />
          </div>
        </div>
      </div>
      <div className="h-auto pt-10 sm:pt-20 lg:pt-32 sm:pb-32 md:pb-44 lg:pb-48 2xl:pb-56 pb-28">
        <div className="container mx-auto relative z-20 text-white px-5 py-10  text-center">
          ...
          <p
            className={`font-quicksand text-sm sm:text-lg sm:px-10 lg:mt-10 lg:px-28 sm:leading-8 lg:leading-9 2xl:leading-[47px] font-normal lg:text-2xl xl:text-2xl 2xl:text-3xl leading-7 mt-5 `}
          >
            {t("text")}
          </p>
        ...
        <div className=" w-full absolute  z-20  -bottom-40 min-[363px]:-bottom-12  bas:top-72 sm:top-auto sm:-bottom-16 xl:-bottom-32">
          <div className="container mx-auto flex-wrap gap-3 px-5 flex justify-center  ">
            {arrayContactImg.map((items, i) => (
              <div
                key={items.id}
                className={`${i == 3 && "hidden mt-3 bas:block"} ${i !== 1 && i !== 3 && " mb-3 bas:mb-0 "} w-[100px] sm:w-32 md:w-40 lg:w-52 xl:w-72 2xl:w-96 flex items-end bas:items-center aspect-square`}
              >
                <Image
                  alt="imgs "
                  className={` ${i == 0 ? " object-contain" : "object-center"} aspect-square object-cover rounded-2xl`}
                  src={items.imgs}
                />
              </div>
            ))}
