...
const BlogsMain = () => {
  ...
  return (
         <div className='relative w-full'>
                <Image
                    alt="background"
                    className=" w-full object-bottom h-[50vh] sm:h-[70vh] transition-all md:h-[80vh] lg:h-[92vh]   "
                    width={1920}
                    height={1080}
                    src={MainImg}
                  />
         <div className="absolute text-start pt-10 sm:pt-20  md:pt-0 w-full h-full  top-0  ">
           ...
           <h1 className={`${PoppinFont.className } md:w-3/4  sm:px-2 dort:text-2xl text-xl sm:text-3xl  lg:text-4xl xl:text-4xl 2xl:text-5xl  font-bold text-white leading-8 lg:leading-[65px] xl:leading-[70px] tracking-wide`}>{t("title")}</h1>
