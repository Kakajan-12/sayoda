          ...
          >
            ...
            <div className="z-10 relative text-white px-7 py-7 h-full flex flex-col items-center justify-end sm:p-7">
              ...
              >
                <button
                  type="button"
                  disabled={navigatingBlogId === item.id}
                  className="bg-white text-xs rounded-full w-36 font-bold self-center py-2 lg:py-3 lg:text-sm text-black disabled:opacity-70 disabled:cursor-wait"
                  onClick={() => handleBlogClick(item.id)}
                >
                  {navigatingBlogId === item.id ? (
