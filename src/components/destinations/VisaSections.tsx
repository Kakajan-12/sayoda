 ...
 *
 * Содержимое вынесено из страницы, потому что адресов у него теперь два:
 * /turkmenistan-visa для Туркменистана и /destinations/<страна>/visa для
 * остальных.
 */
export default async function VisaSections({
  locale,
  country,
}: {
  locale: string;
