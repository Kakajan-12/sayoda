...
import { getHotels, getLocalizedHotelField, type Hotel } from "@/lib/api/hotels";
...
export default function DestinationHotels({ country }: { country: string }) {
  ...
  return (
    <div className="flex flex-col gap-6 lg:flex-row">
      {/* City filter */}
      <aside className="h-fit w-full shrink-0 rounded-2xl border border-gray-200 bg-white p-2 lg:sticky lg:top-40 lg:w-56 lg:self-start">
