 ...
 * не с кем поговорить. Формулировки короткие: это не рассказ о компании,
 * а список причин, который просматривают глазами.
 *
 * Про оплату здесь ничего нет. Во-первых, приёма платежей на сайте не
 * существует и обещать его нельзя. Во-вторых, по решению заказчика сайт
 * условий оплаты не объясняет вовсе — их обсуждают в переписке.
 *
 * Последний пункт, «без скрытых доплат», оставлен намеренно: он про состав
 * цены, которая на сайте есть, а не про то, когда и чем платить.
 *
